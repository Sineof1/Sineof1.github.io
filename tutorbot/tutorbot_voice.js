...
$('#slope1').bind('keyup', function(evt) {
   ...
   var d = new Date();
   $('#botImage').attr('src', 'monsterbot.gif?' + d.getTime());
...
function hintGroup1() {
  ...
  setTimeout(function(){
  window.speechSynthesis.cancel();
  var msg = new SpeechSynthesisUtterance('Okay, so you want to determine the slope of line <say-as interpret-as="characters">g</say-as>. How can I help?');
  msg.pitch = 2;
  ...
  botUI.message.bot({type : 'html', content: 'Okay, so you want to determine the <strong>slope</strong> of <strong>line g</strong>.<br /><br />How can I help?  😃'})
               ...
               .then(function(res){
                  ...
                  botUI.message.bot({type : 'html', delay: 2000, loading: true, content: $('#hint1').html()})
                       ...
                       .then(function(){var d = new Date(); $('#botImage').attr('src', 'monsterbot.gif?' + d.getTime());});
                  }
